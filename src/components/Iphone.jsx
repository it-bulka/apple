...
import IphoneGlb from "src/assets/models/scene.glb";
...
export const Iphone = memo((props) => {
    const { nodes, materials } = useGLTF(IphoneGlb)
    const texture = useTexture(props.item.img)

    useEffect(() => {
      Object.entries(materials).map((material) => {
        // all part should change color but these several
        if (
